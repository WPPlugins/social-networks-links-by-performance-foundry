...
class Foundry_Social_Links_Widget extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'display_name' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'display_name' ) ); ?>" type="checkbox" value="true" <?php echo $is_checked; ?>">
		</p>
